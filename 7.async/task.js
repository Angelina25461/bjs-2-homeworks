class AlarmClock {
    ...
    addClock(time, callback) {
        ...
        else if (this.alarmCollection.some(clock => clock.time === time && clock.callback === callback)){
    ...
    start() {
        ...
        this.intervalId = setInterval(() => this.alarmCollection.forEach(clock => check(clock)), 1000); 
    }
